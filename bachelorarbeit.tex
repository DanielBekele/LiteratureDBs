...
The registration problem is defined as finding the matching transformation for one set of data to match to a target set of data.%BELEG
...
%The main goal of this thesis is to investigate if this coarse alignment problem can be solved more efficiently by introducing the user to a virtual environment capable of fully displaying the point clouds in all three dimensions and how accurate an alignment in this environment is, based on a ground truth data set. 
...
%Deselection function not biuld in!!!!
...
The following formula extracts this angle out of a quarternion by using the real part re of the quarternion $q_e$:%REALPART?
\[
	\alpha_e = 2 *  acos ( re )
\]
